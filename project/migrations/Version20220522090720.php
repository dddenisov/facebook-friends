 ...
 */
final class Version20220522090720 extends AbstractMigration
{
        ...
        $this->addSql('
            ...
            BEGIN
                ...
                if max_recursion = 0 then
                    # a default to protect the innocent
    ...
    {
        $this->addSql('DROP PROCEDURE WITH_EMULATOR;');
    }
}
